 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "onsemimatrixpush.com", ownerName = "onsemimatrixpush.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyB3QFVgQtM3uaAPxgmFPTz469H2l5cx9kI";
